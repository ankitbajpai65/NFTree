...
const OrganizationDetails = ({ steps, activeStep, handleBack, handleNext, kycDetails, setKycDetails }) => {
                            ...
                            <Grid item xs={field.xs || 12} key={index}>
                                ...
                                {field.type === 'file' ? (
                                    <>
                                        ...
                                        <p style={uploadedFileInfo}>{formik.values.regProof ? `${formik.values.regProof.name}` : 'No file selected'}</p>
