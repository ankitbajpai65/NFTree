...
const RepresentativeDetails = ({ steps, activeStep, handleBack, handleNext, kycDetails, setKycDetails }) => {
            ...
            <Grid item xs={12} sx={{ padding: "20px" }}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                        ...
                        <p style={uploadedFileInfo}>{formik.values.signedNote ? `${formik.values.signedNote.name}` : 'No file selected'}</p>
